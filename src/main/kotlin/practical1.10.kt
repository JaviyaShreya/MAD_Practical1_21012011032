...
fun main() {
    println("21012011032 || Javiya Shreya")
    println("Creating Car Class Object car1 in next line")
    val car1 = Car("KIA, 2018","Shreya",105, 10000.0,98950.0)
    car1.displayCarInfo()
    println("Creating Car Class Object car2 in next line")
    val car2 = Car("Audi, 2019","Vanshu",20, 400000.0,399800.0)
    car2.displayCarInfo()
    println("\n**** ArrayList of Car ****")
    val carlist = ArrayList<Car>()
    carlist.add(Car("Swift, 2017","Palak",100,1080000.0,1079000.0))
    carlist.add(Car("I20, 2020","krina",200,4000000.0,3998000.0))
